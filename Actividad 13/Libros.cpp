...
void buscarespanol() {
    ...
    if(contador>0)
    cout << "SI se encontraron libros en espanol (" << contador << ")" << endl;
    else
    cout << "NO se encontraron libros en espanol" << endl;
}
...
void buscarcf() {
    ...
    if(contador>0)
    cout << "SI se encontraron libros de ciencia ficcion (" << contador << ")" << endl;
    else
    cout << "NO se encontraron libros de ciencia ficcion" << endl;
}
    ...
    do{
        ...
        switch(opcion){
            ...
            case 6: cout << "Buscando..." << endl;
                buscarcf();
                break;
            case 7: cout << "Eliminando los libros..." << endl;
                eliminarmisterio();
                break;
